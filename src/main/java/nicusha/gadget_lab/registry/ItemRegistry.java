...
public class ItemRegistry {
    ...
    public static final DeferredItem<Item> pocket_watch = registerItem("pocket_watch", () -> new ItemMod(new Item.Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(MODID, "pocket_watch")))));
