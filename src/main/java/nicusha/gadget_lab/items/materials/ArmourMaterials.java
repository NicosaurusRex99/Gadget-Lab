...
public interface ArmourMaterials {
    ...
    ArmorMaterial GRAVITY_BOOTS = registerArmorMaterial("gravity_boots", 0, createDefenseMap(1, 0, 0, 0, 0), 1, SoundEvents.ARMOR_EQUIP_IRON, 0.0F, 0.0F, ItemTags.create(Identifier.fromNamespaceAndPath(MODID, "slime_ball_repair")));
    ArmorMaterial REBREATHER = registerArmorMaterial("rebreather", 0, createDefenseMap(0, 0, 0, 0, 0), 1, SoundEvents.ARMOR_EQUIP_CHAIN, 0.0F, 0.0F, ItemTags.create(Identifier.fromNamespaceAndPath(MODID, "air_repair")));
    ArmorMaterial INVISIBILITY_CLOAK = registerArmorMaterial("invisibility_cloak", 0, createDefenseMap(0, 0, 0, 0, 0), 1, SoundEvents.ARMOR_EQUIP_GENERIC, 0.0F, 0.0F, ItemTags.create(Identifier.fromNamespaceAndPath(MODID, "air_repair")));
