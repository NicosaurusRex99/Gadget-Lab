...
//        this.repairIngredient = repairIngredient == null ? Ingredient.EMPTY : Ingredient.of(BuiltInRegistries.ITEM.get(new ResourceLocation(Main.MODID, repairIngredient)));
//
//    }
